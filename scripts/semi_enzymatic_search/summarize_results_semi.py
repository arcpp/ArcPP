...
datasets = {
    ...
    #     'folders': [''],
    #     'result_file': 'SA______pmap_unified_merged_percolator_3_4_0_validated_combine_pep_1_0_0_accepted_merged_sanitized.csv',
    #     'original_file': os.path.join('original_results', 'PXD000202_original_results_99.csv'),
    #     '3engines_file': None,
    #     'combined_file': None,
    # },
    'PXD006877': {
        ...
        #     'Lana-SILAC-4raw',
        # ],
        'result_file': 'Merged_semi_full_Lana-SILAC-_-____pmap_unified_merged_accepted_percolator_3_4_0_validated_combine_pep_1_0_0_accepted_merged_sanitized_merged.csv',
        'original_file': None,# os.path.join('original_results', 'PXD006877_original_results.csv'),
        '3engines_file': None, #os.path.join('incremental_results', 'Lana-SILAC-_-____pmap_unified_percolator_2_08_validated_accepted_merged_merged_sanitized_merged.csv'),
        'combined_file': None, #os.path.join('incremental_results', 'Lana-SILAC-_-____pmap_unified_percolator_2_08_validated_combine_pep_1_0_0_accepted_merged_sanitized_merged.csv'),
    },
    'PXD007061': {
        'lab': 'De_Castro',
        'num_spectra': 6847689,
        ...
        'identified_peptides': dict(),
        # 'folders': ['IP', 'labeling'],
        'result_file': os.path.join('labeling', 'Merged_semi_full_-top20___pmap_unified_accepted_percolator_3_4_0_validated_combine_pep_1_0_0_accepted_merged_sanitized_merged.csv'),
        'original_file': None,# os.path.join('original_results', 'PXD007061_original_results.csv'),
        '3engines_file': None,
        'combined_file': None,
    },
    'PXD009116': {
        ...
        'identified_peptides': dict(),
        # 'folders': [''],
        'result_file': 'Merged_semi_full_WT__ed_accepted_percolator_3_4_0_validated_combine_pep_1_0_0_accepted_merged_sanitized_merged.csv',
        'original_file': None,# os.path.join('original_results', 'PXD009116_original_results.csv'),
        '3engines_file': None,
        'combined_file': None,
    },
    'PXD010824': {
        ...
        'identified_peptides': dict(),
        # 'folders': [''],
        'result_file': 'Merged_semi_full_StS_Hvo_0405____pmap_unified_accepted_percolator_3_4_0_validated_combine_pep_1_0_0_accepted_merged_sanitized_merged.csv',
        'original_file': None,# os.path.join('original_results', 'PXD010824_original_results.csv'),
        '3engines_file': None,
        'combined_file': None,
    },
    'PXD011012': {
        ...
        'identified_peptides': dict(),
        # 'folders': ['gluc', 'try'],
        # 'result_file': 'Merged_gluc_try_semi_full.csv',
        'result_file': os.path.join('try', 'Merged_try_semi_full_combined_sanitized_all.csv'),
        'original_file': None,# os.path.join('original_results', 'PXD011012_original_results.csv'),
        '3engines_file': None,
        'combined_file': None,
    },
    # 'PXD011015': {
    ...
    #     'identified_peptides': dict(),
    #     # 'folders': ['iscid', 'topx'],
    #     'result_file': os.path.join('topx', 'Merged_semi_full_StS-Pili-_ed_accepted_percolator_3_4_0_validated_combine_pep_1_0_0_accepted_merged_sanitized_merged.csv'),
    #     'original_file': None,# os.path.join('original_results', 'PXD011015_original_results.csv'),
    #     '3engines_file': None,
    #     'combined_file': None,
    # },
    'PXD011050': {
        ...
        # 'result_file': 'Merged_gluc_try_semi_full.csv',#[
        'result_file': os.path.join('try', 'Merged_try_semi_full_combined_sanitized_all.csv'),
        'original_file': None,# os.path.join('original_results', 'PXD011050_original_results.csv'),
        '3engines_file': None,
        'combined_file': None,
    },
    'PXD011056': {
        ...
        'identified_peptides': dict(),
        # 'folders': [''],
        'result_file': 'Merged_semi_full_Z_Jevtic_0____pmap_unified_merged_accepted_percolator_3_4_0_validated_combine_pep_1_0_0_accepted_merged_sanitized_merged.csv',
        'original_file': None,# os.path.join('original_results', 'PXD011056_original_results.csv'),
        '3engines_file': None,
        'combined_file': None,
    },
    'PXD011218': {
        ...
        'identified_peptides': dict(),
        # 'folders': [''],
        'result_file': 'Merged_semi_full_ed_accepted_percolator_3_4_0_validated_combine_pep_1_0_0_accepted_merged_sanitized_merged.csv',
        'original_file': None,# os.path.join('original_results', 'PXD011218_original_results.csv'),
        '3engines_file': None, #os.path.join('incremental_results', 'pmap_unified_percolator_2_08_validated_accepted_merged_merged_sanitized.csv'),
        'combined_file': None, #os.path.join('incremental_results', 'pmap_unified_percolator_2_08_validated_combine_pep_1_0_0_accepted_merged_sanitized.csv'),  
    },
    'PXD013046': {
        'lab': 'De_Castro',
        'num_spectra': 4291777,
        ...
        #     'WT3',
        # ],
        'result_file': 'Merged_semi_full_pmap_unified_merged_accepted_percolator_3_4_0_validated_combine_pep_1_0_0_accepted_merged_sanitized_merged.csv',
        'original_file': None,# os.path.join('original_results', 'PXD013046_original_results.csv'),
        '3engines_file': None,
        'combined_file': None,
    },
    # 'PXD014974': {
    ...
    #     'identified_peptides': dict(),
    #     # 'folders': [''],
    #     'result_file': 'POL11409X00____pmap_unified_percolator_3_4_0_validated_combine_pep_1_0_0_accepted_merged_sanitized.csv',
    #     'original_file': os.path.join('original_results', 'PXD014974_original_results.csv'),
    #     '3engines_file': None,
    #     'combined_file': None,
    # },
}
...
def main(dirpath, skip_old=False, num_specs=1):
    ...
    if os.path.exists(pkl_name) and skip_old is True:
        ...
        fdr_dict = pickle.load(
            open(fdr_pkl_name, 'rb')
        )
        old_exists = True
    else:
        ...
        results_dict = {
            'all': {
                ...
                'protein_groups': {'all': set(), 'safe_psm': set(), 'safe_seq': set(), 'safe_seq_num_spec': set(), 'safe_seq_num_spec_0005': set()},
                'proteins': {'all': set(), 'safe_psm': set(), 'safe_seq': set(), 'safe_seq_num_spec': set(),'safe_seq_num_spec_0005': set()},
    ...
    for PRIDE_ID in datasets.keys():
        ...
        with open(merged_file, 'r') as in_file:
            ...
            for line_dict in result_csv:
                ...
                if 'full' in line_dict['Enzyme Specificity']:
                    semi = 'full'
                elif 'semi' not in line_dict['Enzyme Specificity']:
                    print('This should never happen:')
                    print('enzyme specificity neither full nor semi')
                    print(line_dict['Enzyme Specificity'])
                    exit()
                else:
                    semi = 'semi'
                ...
                if psm_q_value <= 0.01:
                    ...
                    if seq not in fdr_dict['peptides_psm_level'][seq_length].keys():
                        fdr_dict['peptides_psm_level'][seq_length][seq] = (psm_q_value, is_decoy)
                    elif psm_q_value < fdr_dict['peptides_psm_level'][seq_length][seq][0]:
                        fdr_dict['peptides_psm_level'][seq_length][seq] = (psm_q_value, is_decoy)
                else:
                    print('Results should be filtered by combined PEP <= 1% (but should contain targets and decoys)')
                    sys.exit(1)
                ...
                if len(prot.split('<|>')) >1 :
                    ...
                    if contaminants is False and is_decoy == 'false':
                        results_dict[PRIDE_ID]['protein_groups']['all'].add(line_dict['Protein ID'])
                ...
                if results_dict[PRIDE_ID]['protein_dict'][prot][seq]['semi'] != semi:
                    if seq == 'AIPFRPAVHLE':
                        continue
                    # elif seq in ['VVVIPDSEL', 'NTIGDWLQK', 'VIWTSDSGSSSSTLQSWTYNG', 'VQDAGLKPE']:
                    #     results_dict[PRIDE_ID]['protein_dict'][prot][seq]['semi'] = 'full+semi'
                    else:
                        # print('different enzyme specificity for same peptide: {0} and {1}'.format(
                        #     results_dict[PRIDE_ID]['protein_dict'][prot][seq]['semi'], semi
                        # ))
                        print(seq)
                        # exit()
                        results_dict[PRIDE_ID]['protein_dict'][prot][seq]['semi'] = 'full+semi'
            ...
            if datasets[PRIDE_ID][file_type] is not None:
                ...
                with open(filepath_org, 'r') as in_file:
                    ...
                    for line_dict in result_csv:
                        ...
                        spec_title = line_dict['Spectrum Title']
                        results_dict[PRIDE_ID][results_type]['peptides']['all'].add(seq)
                        results_dict[PRIDE_ID][results_type]['spectra']['all'].add(spec_title)
        ...
        for results_type in ['original_results', '3engines_results', 'combined_results']:
            for level in ['peptides', 'spectra']:
                results_dict['all'][results_type][level]['all'] |= results_dict[PRIDE_ID][results_type][level]['all']
        for prot in results_dict[PRIDE_ID]['protein_dict'].keys():
            ...
            for seq in results_dict[PRIDE_ID]['protein_dict'][prot].keys():
                start_stop = results_dict[PRIDE_ID]['protein_dict'][prot][seq]['start_stop']
                semi = results_dict[PRIDE_ID]['protein_dict'][prot][seq]['semi']
                ...
                for k, v in results_dict[PRIDE_ID]['protein_dict'][prot][seq].items():
                    if k in ['start_stop', 'semi']:
                        continue
                    else:
                        results_dict['all']['protein_dict'][prot][seq][k].extend(v)
                    results_dict['all']['protein_dict'][prot][seq]['datasets'].add(PRIDE_ID)
    ...
    for PRIDE_ID in results_dict.keys():
        ...
        seq_calc_q_value_dict = calculate_q_value_by_group(seq_q_value_dict, sliding=False)
        ...
        for prot in results_dict[PRIDE_ID]['protein_dict'].keys():
            ...
            for seq in results_dict[PRIDE_ID]['protein_dict'][prot].keys():
                ...
                results_dict[PRIDE_ID]['protein_dict'][prot][seq]['seq_q_value'] = seq_q_value
                ...
                if seq_q_value <= SEQ_Q_VALUE_THRESHOLD:
                    if PRIDE_ID == 'all':
                        ...
                        fdr_dict['peptides_seq_level'][seq_length][seq] = (seq_q_value, is_decoy)
                    counts = len(set(results_dict[PRIDE_ID]['protein_dict'][prot][seq]['spec_title']))
                    if is_decoy is False and contaminants is False:
                        ...
                        if counts >= num_specs:
                            ...
                            if PRIDE_ID == 'all':
                                if seq_length not in fdr_dict['peptides_seq_level_2specs'].keys():
                                    fdr_dict['peptides_seq_level_2specs'][seq_length] = {}
                                fdr_dict['peptides_seq_level_2specs'][seq_length][seq] = (seq_q_value, is_decoy)
                    min_bayes_pep = min(
                        results_dict[PRIDE_ID]['protein_dict'][prot][seq]['bayes_pep']
                    )
                    ...
                    if prot not in prot_q_value_dict['seq_level'].keys():
                        ...
                        prot_q_value_dict['seq_level'][prot]['Bayes PEP'] += log_seq_bayes

                for bayes_pep in results_dict[PRIDE_ID]['protein_dict'][prot][seq]['bayes_pep']:
                    if bayes_pep == 0.0:
                    ...
                    if prot not in prot_q_value_dict['psm_level'].keys():
                        ...
                        prot_q_value_dict['psm_level'][prot]['Bayes PEP'] += log_seq_bayes

        print('calculating q-values on protein level')
        prot_calc_q_value_dict = calculate_q_value_by_group(prot_q_value_dict, sliding=False, picked_fdr=True)
        ...
        for prot in results_dict[PRIDE_ID]['protein_dict'].keys():
            ...
            for level in ['psm_level', 'seq_level']:
                ...
                samples = set()
                for seq in results_dict[PRIDE_ID]['protein_dict'][prot].keys():
                    if seq in ['datasets', 'prot_q_value_seq', 'prot_q_value_psm', 'samples']:
                        continue
                    if results_dict[PRIDE_ID]['protein_dict'][prot][seq]['seq_q_value'] > 0.01:
                        continue
                    psm_set = set(results_dict[PRIDE_ID]['protein_dict'][prot][seq]['spec_title'])
                    counts += len(psm_set)
                    for psm in psm_set:
                ...
                if PRIDE_ID == 'all':
                    if level == 'seq_level':
                        fdr_dict['proteins_seq_level'][prot] = (
                            prot_bayes_pep,
                            is_decoy
                        )
                        if counts >= num_specs:
                        ...
                        fdr_dict['proteins_psm_level'][prot] = (
                            prot_bayes_pep,
                            is_decoy
                        )
                if prot_q_value <= 0.01 and is_decoy is False and contaminants is False:
                    if level == 'seq_level':
                        if len(prot.split('<|>')) > 1:
                            results_dict[PRIDE_ID]['protein_groups']['safe_seq'].add(prot)
                            if counts >= num_specs:
                                results_dict[PRIDE_ID]['protein_groups']['safe_seq_num_spec'].add(prot)
                                if prot_q_value <= PROT_Q_VALUE_THRESHOLD:
                                    results_dict[PRIDE_ID]['protein_groups']['safe_seq_num_spec_0005'].add(prot)
                        else:
                            results_dict[PRIDE_ID]['proteins']['safe_seq'].add(prot)
                            if counts >= num_specs:
                                results_dict[PRIDE_ID]['proteins']['safe_seq_num_spec'].add(prot)
                                if prot_q_value <= PROT_Q_VALUE_THRESHOLD:
                                    results_dict[PRIDE_ID]['proteins']['safe_seq_num_spec_0005'].add(prot)
                    elif counts >= num_specs:
                        if len(prot.split('<|>')) > 1:
                            results_dict[PRIDE_ID]['protein_groups']['safe_psm'].add(prot)
                        else:
                            results_dict[PRIDE_ID]['proteins']['safe_psm'].add(prot)
                if level == 'seq_level':
                    results_dict[PRIDE_ID]['protein_dict'][prot]['prot_q_value_seq'] = prot_q_value
                else:
                    results_dict[PRIDE_ID]['protein_dict'][prot]['prot_q_value_psm'] = prot_q_value
                results_dict[PRIDE_ID]['protein_dict'][prot]['samples'] = samples
        print('Number of confident protein identifications for {0}: {1}'. format(
            PRIDE_ID, 
    ...
    for group in dict_for_calc.keys():
        ...
        if sliding:
            for i, (n_decoys, __, current_win_size) in enumerate(
                ...
                dict_for_calc[group][current_seq]['combined PEP'] = \
                    group_q_value
