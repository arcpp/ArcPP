...
offsets = {
    'StS_Hvo_0405_cytosol_B_FASP_v5_26102016.mzML': 2,
    'StS_Hvo_0405_KK_cytosol_B_FASP_v5_26102016.mzML': 2,
    'StS_Hvo_0405_KK_membrane_B_FASP_v5_26102016.mzML': 2,
    'StS_Hvo_0405-KK_Try_cytosol_Big12_20160927.mzML': 2,
    'StS_Hvo_0405-KK_Try_membrane_Big12_20160927.mzML': 2,
    'StS_Hvo_0405_membrane_B_FASP_v5_26102016.mzML': 2,
    'StS_Hvo_0405_Try_cytosol_Big12_20160927.mzML': 2,
    'StS_Hvo_0405_Try_membrane_Big12_20160927.mzML': 2,
}
...
def main(folder=None, enzyme=None, target_decoy_database=None):
    ...
    for n, sample in enumerate(sorted(offsets.keys())):
        ...
        for search_engine in search_engines:
            ...
            uc.params['rt_pickle_name'] = os.path.join(
                dirname,
                '_ursgal_lookup.pkl',
            )
