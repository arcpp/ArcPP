...
datasets = {
    ...
    'PXD006877': {
        ...
        'result_file': 'Lana-SILAC-_-____pmap_unified_merged_percolator_3_4_0_validated_combine_pep_1_0_0_accepted_merged_sanitized.csv',
        'original_file': os.path.join('original_results', 'PXD006877_original_results.csv'),
        '3engines_file': os.path.join('incremental_results', 'Lana-SILAC-_-____pmap_unified_percolator_2_08_validated_accepted_merged_merged_sanitized_merged.csv'),
        'combined_file': os.path.join('incremental_results', 'Lana-SILAC-_-____pmap_unified_percolator_2_08_validated_combine_pep_1_0_0_accepted_merged_sanitized_merged.csv'),
    },
    'PXD007061': {
        'lab': 'De_Castro',
        'num_spectra': 6847689,
        ...
        'identified_peptides': dict(),
        'folders': ['IP', 'labeling'],
        'result_file': 'pmap_unified_percolator_3_4_0_validated_combine_pep_1_0_0_accepted_merged_sanitized_merged.csv',
        'original_file': os.path.join('original_results', 'PXD007061_original_results.csv'),
        '3engines_file': None,
        'combined_file': None,
    },
    'PXD009116': {
        ...
        'identified_peptides': dict(),
        'folders': [''],
        'result_file': 'WT__ed_percolator_3_4_0_validated_combine_pep_1_0_0_accepted_merged_sanitized.csv',
        'original_file': os.path.join('original_results', 'PXD009116_original_results.csv'),
        '3engines_file': None,
        'combined_file': None,
    },
    'PXD010824': {
        ...
        'identified_peptides': dict(),
        'folders': [''],
        'result_file': 'StS_Hvo_0405____pmap_unified_percolator_3_4_0_validated_combine_pep_1_0_0_accepted_merged_sanitized.csv',
        'original_file': os.path.join('original_results', 'PXD010824_original_results.csv'),
        '3engines_file': None,
        'combined_file': None,
    },
    'PXD011012': {
        ...
        'original_file': os.path.join('original_results', 'PXD011012_original_results.csv'),
        '3engines_file': None,
        'combined_file': None,
    },
    'PXD011015': {
        ...
        'identified_peptides': dict(),
        'folders': ['iscid', 'topx'],
        'result_file': 'ed_percolator_3_4_0_validated_combine_pep_1_0_0_accepted_merged_sanitized_merged.csv',
        'original_file': os.path.join('original_results', 'PXD011015_original_results.csv'),
        '3engines_file': None,
        'combined_file': None,
    },
    'PXD011050': {
    ...
    'PXD011056': {
        ...
        'identified_peptides': dict(),
        'folders': [''],
        'result_file': 'ZJ_____pmap_unified_merged_percolator_3_4_0_validated_combine_pep_1_0_0_accepted_merged_sanitized.csv',
        'original_file': os.path.join('original_results', 'PXD011056_original_results.csv'),
        '3engines_file': None,
        'combined_file': None,
    },
    'PXD011218': {
        ...
        'identified_peptides': dict(),
        'folders': [''],
        'result_file': 'ed_percolator_3_4_0_validated_combine_pep_1_0_0_accepted_merged_sanitized.csv',
        'original_file': os.path.join('original_results', 'PXD011218_original_results.csv'),
        '3engines_file': os.path.join('incremental_results', 'pmap_unified_percolator_2_08_validated_accepted_merged_merged_sanitized.csv'),
        'combined_file': os.path.join('incremental_results', 'pmap_unified_percolator_2_08_validated_combine_pep_1_0_0_accepted_merged_sanitized.csv'),  
    },
    'PXD013046': {
        'lab': 'De_Castro',
        'num_spectra': 4291777,
        ...
        'result_file': 'pmap_unified_merged_percolator_3_4_0_validated_combine_pep_1_0_0_accepted_merged_sanitized.csv',
        'original_file': os.path.join('original_results', 'PXD013046_original_results.csv'),
        '3engines_file': None,
        'combined_file': None,
    },
    'PXD014974': {
